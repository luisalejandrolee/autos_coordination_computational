...
to set-some-variables
  ...
  if n-signals = 1 [  ;Measure only if signal is used
    ...
    ;; Not to be printed in the "useless-signal" test. Since all signals are alwasy H, there's never any T, hence times-tails=0, creating a division by zero error.
...
to print-outputs-summary ;This is to print overall tables. Is basically the same I could do on Behaviour Space.
  ...
  let path-file "/Users/luisalejandrolee/Dropbox/Thesis Phd/Coordination autos Chapter three/outputs_from_netlogo"
...
<experiments>
  ...
  <experiment name="no behaviour output (only print through code)" repetitions="1" runMetricsEveryStep="true">
    ...
    <enumeratedValueSet variable="files-name-modifier">
      <value value="&quot;useless_signal_test&quot;"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="N">
      <value value="40"/>
    </enumeratedValueSet>
