...
to-report exogenous-signal
  ...
  ;The signal-card is no longer used in order to give players independent signals.
  ;So for each player, a simple H or T is reported.
...
<experiments>
  ...
  <experiment name="no behaviour output (only print through code)" repetitions="1" runMetricsEveryStep="true">
    ...
    <enumeratedValueSet variable="files-name-modifier">
      <value value="&quot;independent-signals&quot;"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="N">
      <value value="40"/>
    </enumeratedValueSet>
